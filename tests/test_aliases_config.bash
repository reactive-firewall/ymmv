...
LOCK_FILE="/tmp/bash_aliases_test_script_lock"
...
if [[ -f ../dot_bash_aliases ]] ; then
	bash --posix --norc -c 'source ../dot_bash_aliases' || EXIT_CODE=1
elif [[ -f ./dot_bash_aliases ]] ; then
	bash --posix --norc -c 'source ./dot_bash_aliases' || EXIT_CODE=1
else
	echo "FAIL: missing bash aliases file"
	EXIT_CODE=1
fi
