...
## EDIT:
# this copy was found in
# advanced_bash_scripting_guide under contributed-scripts (A-8)
# http://tldp.org/LDP/abs/html/contributed-scripts.html#MAKEDICT
# circa 2017
# see http://tldp.org/LDP/abs/html/copyright.html for details
