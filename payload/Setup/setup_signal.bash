...
sud https://updates.signal.org/desktop/signal-desktop-mac-5.4.1.dmg /tmp/signal-desktop-mac.dmg || exit 1 ;
...
pkgbuild --analyze --root /Volumes/signal-desktop-mac/ --filter Applications --filter .DS_Store --filter .background --filter .fseventsd --filter ._.DS_Store --filter ./.Icon --filter ./._Icon --identifier org.whispersystems.signal-desktop --version 5.4.1 /tmp/signal_components.plist
pkgbuild --root /Volumes/signal-desktop-mac/ --install-location /System/Volumes/Data/Applications/ --filter Applications --filter .DS_Store --filter .background --filter .fseventsd --filter ._.DS_Store --filter .Icon --filter ./._ --identifier org.whispersystems.signal-desktop --version 5.4.1 --component-plist /tmp/signal_components.plist /tmp/signal_installer.pkg
wait ; sync ; wait ;
